...
bigram_finder = nltk.BigramCollocationFinder.from_words(r.lemmata)
...
trigram_finder = nltk.TrigramCollocationFinder.from_words(r.lemmata)
...
quadrigram_finder = nltk.QuadgramCollocationFinder.from_words(r.lemmata)
