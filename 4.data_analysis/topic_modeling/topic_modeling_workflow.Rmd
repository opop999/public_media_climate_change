...
nmf_topic_modeling <- function(i) {
    ...
    model_nmf <- nmf(dtm_less_sparse, k = i, seed = 3859L, maxit = 1000, tol = 0.001)
    topic_word_distribution <- predict(model_nmf, dtm_less_sparse)
    ...
    open.browser = FALSE,
    browse = FALSE,
    description = paste("Climate NMF topic model with", i, "topics (with adjectives)")
  )
...
climate_model_nmf <- nmf(climate_dtm, k = 20, seed = 3859L, maxit = 1000, tol = 0.001)
topic_word_distribution <- predict(climate_model_nmf, climate_dtm)
