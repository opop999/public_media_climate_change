...
# Regex search string based on suggestions from area experts. \\S* (NB capital S) means the word form could be exactly what's in here. \\S+ means there has to be one or more non-whitespace characters after the form here. (Double slash in R, in e.g. Pythoon only one slash.)
